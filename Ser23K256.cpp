...
Ser23K256::Ser23K256(PinName mosi, PinName miso, PinName sck, PinName ncs)
    : _spi(mosi, miso, sck), _ncs(ncs) {
  deselect();
}
...
void Ser23K256::select() { _ncs = 0; }

void Ser23K256::deselect() { _ncs = 1; }
