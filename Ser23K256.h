...
* Copyright (c) 2010 Romilly Cocking, 2016 Kazuki Yamamoto
* Released under the MIT License: http://mbed.org/license/mit
*
* 23K256 data sheet at
* http://ww1.microchip.com/downloads/en/DeviceDoc/22100B.pdf
*
* Page-mode commands have not been implemented; I have found no need for them
* yet.
*
* Assumes spi mode is default (8,0).
*
* You can clock the 23K256 at up to 20MHz, so it supports the mbed's maximum SPI
* frequency of 12MHz.
*/

#include "mbed.h"  // NOLINT

#ifndef SER23K256_H  // NOLINT
#define SER23K256_H
...
class Ser23K256 {
  ...
  * @param ncs    Not chip select pin - any free Digital pin will do
  */
  Ser23K256(PinName mosi, PinName miso, PinName sck, PinName ncs);
